...
source-paths:
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/DST_Collapse_Locus_Stopping_Condition_Report.md"
links-latent: []
---

# Publication Notice and Scope

> **Source** `The-Lambda-Principle-of-Irreducibility/WIP_docs/DST_Collapse_Locus_Stopping_Condition_Report.md`
> 5,193 words · sha `d5f4ad1ac38c` · status **draft**
