...
source-paths:
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/Tail_Predicates_Circumscription_T1.md"
links-latent: []
---

# Tail Predicates and the Circumscription Obstruction

> **Source** `The-Lambda-Principle-of-Irreducibility/WIP_docs/Tail_Predicates_Circumscription_T1.md`
> 4,475 words · sha `70d0aad121f1` · status **draft**

**Detected references:** [[The Obstruction Calculus, Consolidated]]
