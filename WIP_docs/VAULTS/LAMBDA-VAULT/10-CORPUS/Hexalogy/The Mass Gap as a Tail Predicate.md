...
source-paths:
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/Mass_Gap_Tail_Predicate_T3.md"
links-latent: []
---

# The Mass Gap as a Tail Predicate

> **Source** `The-Lambda-Principle-of-Irreducibility/WIP_docs/Mass_Gap_Tail_Predicate_T3.md`
> 5,062 words · sha `527fcf463bd4` · status **draft**

**Detected references:** [[Tail Predicates and the Circumscription Obstruction]] · [[The Hodge Traversal, Compiled Edition (2)]]
