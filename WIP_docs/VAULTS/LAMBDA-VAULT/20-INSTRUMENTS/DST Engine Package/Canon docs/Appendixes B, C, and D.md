...
source-paths:
  - "DST-Canon/foundation/semantic_obstruction_appendix_BCD.md"
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/DST engine v1.0  generalized for claude/CHAT_GPT/PROJECT/CANON/12_CANON_semantic_obstruction_appendix_BCD.md"
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/DST engine v1.0  generalized for claude/Canon docs/semantic_obstruction_appendix_BCD.md"
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/semantic_obstruction_appendix_BCD.md"
links-latent: []
---

# Appendixes B, C, and D

> **Source** `The-Lambda-Principle-of-Irreducibility/WIP_docs/DST engine v1.0  generalized for claude/Canon docs/semantic_obstruction_appendix_BCD.md`
> 5,200 words · sha `e0feaa11c5fd` · status **draft**
> 4 identical copies across DST-Canon, The-Lambda-Principle-of-Irreducibility

**Detected references:** [[Semantic Obstruction and Irreducible Residue]]
