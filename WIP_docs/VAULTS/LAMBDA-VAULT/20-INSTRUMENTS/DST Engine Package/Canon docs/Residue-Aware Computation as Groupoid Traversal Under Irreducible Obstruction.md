...
source-paths:
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/DST engine v1.0  generalized for claude/CHAT_GPT/PROJECT/CANON/10_CANON_residue_groupoid_nsaf_paper_draft.md"
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/DST engine v1.0  generalized for claude/Canon docs/residue_groupoid_nsaf_paper_draft.md"
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/residue_groupoid_nsaf_paper_draft.md"
links-latent: []
---

# Residue-Aware Computation as Groupoid Traversal Under Irreducible Obstruction

> **Source** `The-Lambda-Principle-of-Irreducibility/WIP_docs/DST engine v1.0  generalized for claude/Canon docs/residue_groupoid_nsaf_paper_draft.md`
> 6,233 words · sha `d0f040c2b53e` · status **draft**
