...
source-paths:
  - "The-Lambda-Principle-of-Irreducibility/WIP_docs/QED/QED_INSTALL.md"
links-latent: []
---

# INSTALL — Hosting QED and Running an Instance

> **Source** `The-Lambda-Principle-of-Irreducibility/WIP_docs/QED/QED_INSTALL.md`
> 772 words · sha `b36a2db95edc` · status **draft**
