...
If you’re happy with this, we can now *begin Step 2* (specify admissible transitions (T\_{ij})/kernels (K\_{ij}) precisely), but per your plan we should pause here and reassess before moving on.
